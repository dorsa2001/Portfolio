...
import ImageUrl from "../../Data/businass-casual pic of me.jpg";
        ...
        <Fragment>
            <div className={classes.contactMe} id='getInTouch'>
                ...
                <div className={classes.contactCard}>
                    ...
                    <br></br>
                    <a href={PersonalData.coverLetterLink} target='_blank noreferrer'>
                        <Button className={classes.resumeBtn}>See My Cover Letter</Button>
                    </a>
                </div>
            </div>
            <GetInTouch />
